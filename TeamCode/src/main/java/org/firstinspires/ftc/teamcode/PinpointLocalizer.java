...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -755.98597944; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1750.70437344; // x position of the perpendicular encoder (in tick units)
    }
